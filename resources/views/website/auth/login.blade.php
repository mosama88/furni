...
<head>
    ...
    <style>
        ...
        /* ==================== Auth Page Styles ==================== */
        main {
            flex-grow: 1; /* لضمان نزول الفوتر للأسفل حتى لو المحتوى قليل */
            display: flex;
            align-items: center;
            padding: 60px 0;
        ...
        main::before {
            ...
            background-color: rgba(20, 19, 17, 0.75); /* طبقة داكنة فوق الصورة */
            z-index: 1;
        }
                        ...
                        <div class="auth-body">
                            ...
                            <form action="#" method="POST">
                                ...
                                <div class="mb-4 form-check">
                                    ...
                                    <label class="form-check-label text-muted ms-2" for="remember">تذكرني على هذا الجهاز</label>
                                </div>
